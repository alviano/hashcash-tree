...
from hashcash_tree.primitives import HashcashTree as NewHashcashTree
...
def main(
    ...
    hashcash_tree = HashcashTree.of(prefix_length=prefix_length, size=UINT(size)) if workers >= 0 else NewHashcashTree.of(prefix_length=prefix_length, size=UINT(size))
